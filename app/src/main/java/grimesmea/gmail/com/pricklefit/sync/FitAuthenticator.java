...
/**
 * Manages "Authentication" to the Google Fit History API. The SyncAdapter framework
 ...
 */
public class FitAuthenticator extends AbstractAccountAuthenticator {

    public FitAuthenticator(Context context) {
        super(context);
    }
